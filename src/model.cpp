...
Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene)
{
    ...
    {
        Vertex vertex;
        // use a temp vec3 to store the data from assimp's mesh object
        glm::vec3 vector;
        // positions
    ...
    // process indices
    // we walk through each of the mesh's faces (a face is a mesh its triangle) and retrieve the corresponding vertex indices.
